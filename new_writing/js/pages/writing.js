...
export const selectEmoji = async (event) => {
  ...
  // $("#emojiHappy").prop("checked", true);
  // $("#emojiHappy").prop("checked", false);
  // $("#emojiSad").prop("checked", true);
  // $("#emojiSad").prop("checked", false);
  // $("#emojiChill").prop("checked", true);
  // $("#emojiChill").prop("checked", false);
  // $("#emojiExcited").prop("checked", true);
  // $("#emojiExcited").prop("checked", false);
  // $("#emojiTouched").prop("checked", true);
  // $("#emojiTouched").prop("checked", false);
};

// let emojiSelect = $("input[name=emoji]:checked").val();
// console.log(emojiSelect);

// let emojiSelect = document.querySelector('input[name="emoji"]:checked').value;
